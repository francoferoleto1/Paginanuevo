      ...
      <div class="album py-5 bg-light">
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="http://www.sergiotopor.com/images/folio/single/arcos_1.jpg" alt="Card image cap">
                <div class="card-body">
                  <p class="card-text">Propias</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="http://www.arquimaster.com.ar/web/wp-content/uploads/2013/12/finochietto1.jpg" alt="Card image cap">
                <div class="card-body">
                  <p class="card-text">Propias</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="https://imgar.zonapropcdn.com/avisos/1/00/41/49/55/80/1200x1200/1561661509.jpg" alt="Card image cap">
                <div class="card-body">
                  <p class="card-text">Propias</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
