...
<div class="container marketing" style="padding-bottom: 1vh;">
 	...
 	<hr class="featurette-divider">
        ...
        <hr class="featurette-divider">
         ...
         <div class="row featurette">
          <div class="col-md-7 order-md-2">
            <h2 class="featurette-heading">Instalacion de Calefaccion</h2>
            <p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.</p>
          </div>
          <div class="col-md-5 order-md-1">
            <img class="featurette-image img-fluid mx-auto" src="http://ecoluzgas.com/wp-content/uploads/2017/12/calefaccion-murcia-instalacion-oferta-empresa.jpg" alt="Generic placeholder image">
          </div>
        </div>
